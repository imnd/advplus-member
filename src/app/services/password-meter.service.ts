...
class PasswordMeter {
  ...
  public static createInstances = (
    ...
    elements.forEach((el) => {
      ...
      let passwordMeter = PasswordMeter.getInstance(item)
      if (!passwordMeter) {
        passwordMeter = new PasswordMeter(item, options, queries)
      }
    })
  }
  ...
  public static bootstrap = (selector: string = defaultPasswordMeterQueires.instanseQuery) => {
    PasswordMeter.createInstances(selector)
  }
...
export {PasswordMeter, defaultPasswordMeterOptions, defaultPasswordMeterQueires}
